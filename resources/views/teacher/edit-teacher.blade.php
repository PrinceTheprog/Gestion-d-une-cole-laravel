    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Ajouter Professeur</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('teacher/list/page') }}">Professeur</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms calendar-icon">
                                        <label>Date d'anniversaire <span class="login-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <h5 class="form-title"><span>Details de communication </span></h5>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Repeter le mot de passe <span class="login-danger">*</span></label>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Boite postal <span class="login-danger">*</span></label>
