                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a class="text-success">Non renseigné</a>
                                                @else
                                                <a class="text-success">{{ $list->phone_number }}</a>
                                                @endif
                                        </td>
                                        <td>{{ $list->join_date }}</td>
                                        <td>
                                            @if ($list->role_name ==='Super Admin')
                                                <a class="text-success">Administrateur</a>
                                            @elseif ($list->role_name ==='Teacher')
                                                <a class="text-success">Enseignant</a>
                                            @elseif ($list->role_name ==='Student')
                                                <a class="text-success">Elève</a>
                                            @elseif ($list->role_name ==='Admin')
                                                <a class="text-success">Administrateur</a>
                                            @elseif ($list->role_name ==='Normal User')
                                                <a class="text-success">Parent</a>
                                            @else
