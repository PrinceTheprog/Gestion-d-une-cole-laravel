                    ...
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Liste des Elèves</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="student-box flex-fill">
                                                    <div class="student-img">
                                                        <a href="{{ url('student/profile/'.$list->id) }}">
                                                            <img class="img-fluid" alt="Etudiant Info" src="{{ Storage::url('/student-photos/'.$list->upload) }}" width="20%" height="20%">
                                                        </a>
                                                    </div>
                                                    <div class="student-content pb-0">
                                                        <h5><a href="{{ url('student/profile/'.$list->id) }}">{{ $list->first_name }} {{ $list->last_name }}</a></h5>
                                                        <h3>{{$list->admission_id}}</h3>
                                                        <h6>Elèves</h6>
                                                    </div>
                                                </div>
                                            </div>
