        ...
        <div class="header">
            <div class="header-left">
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ URL::to('assets/img/log.png') }}" alt="Logo">
                    <img src="{{ URL::to('assets/img/text.png') }}" alt="Logo" width="30" height="30">
                </a>
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown noti-dropdown language-drop me-2">
                    ...
                    <div class="dropdown-menu ">
                        <div class="noti-content">
                            <div>
                                <a class="dropdown-item" href="javascript:;"><i class="flag flag-lr me-2"></i>Français</a>                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('user/profile/page') }}">Voir mon profil</a>
